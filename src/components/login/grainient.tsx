  ...
  useEffect(() => {
    ...
    const run = async () => {
      try {
        ...
        loseContext = () => oglGl.getExtension("WEBGL_lose_context")?.loseContext();
        ...
        const setSize = () => {
          ...
          resolution[0] = oglGl.drawingBufferWidth;
          resolution[1] = oglGl.drawingBufferHeight;
