...
export function TopUtilityBar() {
  return (
    <header className="relative z-40 border-b border-white/80 bg-white/55 backdrop-blur-[22px]">
      <div className="mx-auto flex max-w-[1560px] items-center justify-between gap-4 px-4 py-4 sm:px-5 lg:px-8">
        <div className="hidden lg:flex lg:w-[15rem] lg:shrink-0 lg:items-center">
          <UwifiBrandTile
            className="h-[4rem] w-[4rem]"
            imageClassName="w-[2.85rem]"
          />
        </div>
