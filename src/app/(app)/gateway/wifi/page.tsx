      ...
      <div className="mt-5 space-y-4">
        {[
          ...
          <div key={label} className="space-y-1">
            ...
            <div className="theme-input rounded-[1rem] border border-white/80 bg-white/70 px-4 py-3 text-body-sm text-ink-soft shadow-[inset_0_1px_0_rgba(255,255,255,0.9)]">
              {value}
            </div>
          </div>
        ))}
...
export default function GatewayWifiPage() {
  return (
    <div className="space-y-4 lg:flex lg:min-h-0 lg:flex-col">
      ...
      <div className="grid gap-4 lg:min-h-0 lg:flex-1 xl:grid-cols-[minmax(0,1.15fr)_18rem]">
        ...
        <div className="space-y-4">
          <SurfacePanel subtle className="p-4">
            ...
            <div className="mt-4 flex flex-col gap-3">
              <button
                type="button"
                className="theme-cta rounded-pill bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(244,247,244,0.9))] px-4 py-3 text-body-sm text-ink shadow-[0_14px_30px_rgba(201,204,214,0.14)]"
              >
                Save network updates
              </button>
              <button
                type="button"
                className="theme-control rounded-pill border border-white/80 bg-white/60 px-4 py-3 text-body-sm text-ink-soft"
              >
                Restart gateway
              </button>
            </div>
