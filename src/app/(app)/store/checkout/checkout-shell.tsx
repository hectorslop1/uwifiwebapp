      ...
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1.1fr)_22rem]">
        <div className="space-y-5">
          <SurfacePanel className="p-5 sm:p-6">
            ...
            <div className="mt-4 space-y-3">
              {checkoutItems.map((item) => (
                <div
                  key={item.id}
                  className="flex items-center justify-between gap-4 rounded-[1.25rem] border border-white/75 bg-white/55 px-4 py-4"
                >
                  <div>
                ...
                return (
                  <button
                    ...
                    className={`flex w-full items-center justify-between gap-4 rounded-[1.25rem] border px-4 py-4 text-left transition-all duration-200 ${
                      selected
                        ? "border-white/85 bg-white/78 shadow-[0_12px_30px_rgba(201,204,214,0.12)]"
                        : "border-white/70 bg-white/50"
                    }`}
                  >
                    <div className="flex items-center gap-4">
                      <span className="flex h-11 w-11 items-center justify-center rounded-[0.95rem] bg-white/90 text-ink-soft">
          ...
          <SurfacePanel className="p-5 sm:p-6">
            ...
            <div className="mt-4 flex items-center justify-between rounded-[1.2rem] border border-white/75 bg-white/55 px-4 py-4">
              <div>
