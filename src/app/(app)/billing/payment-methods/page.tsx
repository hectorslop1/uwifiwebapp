...
export default function BillingPaymentMethodsPage() {
  return (
    <div className="space-y-5">
      ...
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1.1fr)_19rem]">
        <div className="space-y-4">
          {methods.map((method) => (
            <SurfacePanel key={method.id} className="p-5">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-center gap-4">
                  <span className="flex h-12 w-12 items-center justify-center rounded-[1rem] bg-white/80 text-ink-soft shadow-[inset_0_1px_0_rgba(255,255,255,0.9)]">
        ...
        <SurfacePanel subtle className="p-5">
          ...
          <div className="mt-5 rounded-[1.2rem] border border-white/80 bg-white/55 px-4 py-4 text-body-sm text-ink-muted">
